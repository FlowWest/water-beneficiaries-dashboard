...
- The contractors names are inconsistent accross the datasets that we use to compile their information


## SWP contractor list can be found at DWR's [website](https://water.ca.gov/programs/state-water-project/management/swp-water-contractors)
...
swp <- swp_clean |> 
  mutate(beneficiary_type = "swp contractor",
         ...
         quantity_unit = "maximum annual quantity in acre feet") |> 
