...
-   FlowWest re-mapped the national forest connection using the same
    methodology as the downstream users. This allowed for 2575 entries
    of planned restoration. The mapping to HUC6 was consistent between
    SIG and FlowWest and the the mapping of national forest connection
    was very inconsistent. See: `data_processing.R` for comparison.
...
saveRDS(planned_restoration, here::here("data-raw", "planned_restoration_combined.RDS"))
